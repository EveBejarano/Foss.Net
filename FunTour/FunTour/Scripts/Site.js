...
function EditCities() {
    ...
    location.href = "http://localhost:60195/TravelPackages/EditPlacesReturn/?TravelPackageId=" +
        _packageId +
        "&ToCityId=" +
        _TocityId +
        "&FromCityId=" +
...
function EditBus() {
    ...
    debugger;
    location.href = "http://localhost:60195/TravelPackages/EditServicesToTravelReturn/?TravelPackageId=" +
        _packageId +
        " &ToGoId=" +
        _toGoBusId +
        " &ToBackId=" +
...
function EditServicesInPlace() {
    ...
    debugger;
    location.href = "http://localhost:60195/TravelPackages/EditServicesInPlaceReturn/?TravelPackageId=" +
        _packageId +
        " &EventId=" +
        _eventId +
        " &HotelId=" +
